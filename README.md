...
Then we use the optimal network throughput as the benchmark for our paper: Delayed-Reward Deep Reinforcement Learning Based MaAC protocol for Underwater Acoustic Networks.
